...
namespace test_moves_main_namespace{
    ...
    int main() {
        ...
        std::vector<Move> testMoves {
            ...
            MoveRepresentation::encodeMove(25, 27, board::WK, utility::uncolor(board::EMPTY), 1u),
            ...
            MoveRepresentation::encodeMove(53, 42, board::BP, utility::uncolor(board::EMPTY), 0u, 1u /*TODO: what should this be?*/),
            ...
            MoveRepresentation::encodeMove(31, 22, board::BP, utility::uncolor(board::WN), 0u, 0u, utility::uncolor(board::BQ)),
        }; 
